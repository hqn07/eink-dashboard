...
const DEAD_TILE_SETTINGS = [
  ...
  'bold', 'italic', 'upper', 'letterSpacing', 'scaleAnchor', 'frame',
  // fontFamily is deliberately NOT here. The live world-clock tile carries
  // `fontFamily: 'system'` so it reads in a different face from the serif
  // clock beside it, and the user asked to keep that distinction. Stripping
  // it would have been irreversible in the UI, since the font picker is gone.
  // Stored values keep working; nothing new can set one.
];
