// ESM mirror of lib/home.js — the editor, the SSR render modules and the
// server all need the same answer about where the user lives.
// HAND-MIRRORED: `npm run check:widgets` fails if the two drift.
//
...
export function homeValue(cfg, key) {
...
export function homeCoords(cfg) {
